       ...
       <div class="container">
           <div class="row justify-content-center mb-4">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <form action="${pageContext.request.contextPath}/memberupdateresult" method="post" id="main_contact_form"
            ...
            <!-- 본문 들어가는 부분 -->
                ...
                <div class="form-group">
			                    ...
			                    <div class="col-lg-10">
			                        <input type="text" class="form-control" name="UserNickName" id="UserNickName" value = ${dto.userNickName } readonly >
			                    </div>
			                </div>
                <div class="form-group">
                    <label for="StoreName" class="col-lg-2 control-label">음식점 이름</label>
                    <div class="col-lg-10">
                        <input type="text" class="form-control" name="StoreName" id="StoreName" value=${dto.storeName }>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <input type="text" class="form-control onlyHangul" name="StoreFood" id="name" data-rule-required="true" value=${dto.storeFood }>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <input type="text" class="form-control" name="StoreCall" id="StoreCall"  value=${dto.storeCall }>
                    </div>
                </div>
                <div class="form-group">
                    <label for="StoreCost" class="col-lg-2 control-label">가격대</label>
                    <div class="col-lg-10">
                        <input type="tel" class="form-control onlyNumber" name="StoreCost" id="StoreCost"  value=${dto.storeCost }>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <input type="tel" class="form-control onlyNumber" name="StoreHours" id="StoreHours"  value=${dto.storeHours }>
                    </div>
                </div>
                <div class="form-group">
                    <label for="StoreBTime" class="col-lg-2 control-label">쉬는시간</label>
                    <div class="col-lg-10">
                        <input type="tel" class="form-control onlyNumber" name="StoreBTime" id="StoreBTime"  value=${dto.storeBTime }>
                    </div>
                </div>
                <div class="form-group">
