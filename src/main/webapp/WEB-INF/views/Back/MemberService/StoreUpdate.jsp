...
<body>
	<form method="post" action = "${pageContext.request.contextPath}/memberupdateresult">
		...
		<input type="text" name = "FoodWeather" id = "FoodWeather"  value = "${dto.foodWeather}"><br>
		...
		<input type="text" name = "StoreCost" id = "StoreCost"  value = "${dto.storeCost}"><br>
		<label for = "StoreParking">주차</label>
		<input type="text" name = "StoreParking" id = "StoreParking"  value = "${dto.storeParking}"><br>
		<label for = "StoreHours">영업시간</label>
		<input type="text" name = "StoreHours" id = "StoreHours"  value = "${dto.storeHours}"><br>
		<label for = "StoreBTime">브레이크타임</label>
		<input type="text" name = "StoreBTime" id = "StoreBTime"  value = "${dto.storeBTime}"><br>
		<label for = "StoreClose">휴일</label>
		<input type="text" name = "StoreClose" id = "StoreClose"  value = "${dto.storeClose}"><br>
